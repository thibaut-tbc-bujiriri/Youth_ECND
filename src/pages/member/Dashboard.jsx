...
export default function MemberDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="surface-hero rounded-lg border p-6 shadow-lg sm:p-8">
        <div className="flex items-center gap-3">
          <box-icon name="hand" type="solid" color={theme === "dark" ? "#ffffff" : "#2f6b47"}></box-icon>
          <h1 className={`text-3xl font-bold ${theme === "dark" ? "text-white" : "text-slate-900"}`}>Bienvenue</h1>
        </div>
        <p className={`mt-2 ${theme === "dark" ? "text-slate-200" : "text-slate-700"}`}>
          Vos contributions sont d'abord en attente, puis valides quand un admin les approuve.
        </p>
        <p className={`mt-2 text-sm ${theme === "dark" ? "text-slate-200" : "text-slate-700"}`}>{publicUser?.email}</p>
      </div>

      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6">
        <Link to="/member/contributions" className="cursor-pointer rounded-lg border border-slate-200 p-6 transition hover:border-emerald-500 hover:bg-blue-50">
          <div className="flex items-center gap-2 mb-2">
            <box-icon name="money" type="solid"></box-icon>
        ...
        <Link to="/member/profile" className="cursor-pointer rounded-lg border border-slate-200 p-6 transition hover:border-emerald-500 hover:bg-blue-50">
          <div className="flex items-center gap-2 mb-2">
        ...
        <Link to="/member/stats" className="cursor-pointer rounded-lg border border-slate-200 p-6 transition hover:border-emerald-500 hover:bg-blue-50">
          <div className="flex items-center gap-2 mb-2">
        ...
        <Link to="/member/cv" className="cursor-pointer rounded-lg border border-slate-200 p-6 transition hover:border-emerald-500 hover:bg-blue-50">
          <div className="flex items-center gap-2 mb-2">
            <box-icon name="file" type="solid"></box-icon>
            <p className="font-bold text-lg text-slate-900">Mon CV</p>
          </div>
          <p className="text-slate-600 text-sm">Televerser et gerer votre CV</p>
        </Link>

        <Link to="/member/profile#settings" className="cursor-pointer rounded-lg border border-slate-200 p-6 transition hover:border-emerald-500 hover:bg-blue-50">
          <div className="flex items-center gap-2 mb-2">
